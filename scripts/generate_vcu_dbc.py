...
VALUE_LINES = [
   ...
   'VAL_ 2147483855 SET_VCU_Select 0 "MAX_TORQUE" 1 "MOTOR_DIRECTION" 2 "REGEN_ENABLED" 3 "DEBUG_DEFINES" 4 "WHEEL_DIAMETER" 5 "TRACTION_CONTROL_ENABLED" 6 "TRACTION_CONTROL_TARGET_SLIP" 7 "TRACTION_CONTROL_KP" 8 "TRACTION_CONTROL_KI" 9 "TRACTION_CONTROL_KD" 10 "TRACTION_CONTROL_MIN_FRONT_RPM" 11 "POWER_LIMIT_ENABLED" 12 "POWER_CAP_KW" ;',
   ...
   'VAL_ 2148532431 VCU_Config_Mux 0 "MAX_TORQUE" 1 "MOTOR_DIRECTION" 2 "REGEN_ENABLED" 3 "DEBUG_DEFINES" 4 "WHEEL_DIAMETER" 5 "TRACTION_CONTROL_ENABLED" 6 "TRACTION_CONTROL_TARGET_SLIP" 7 "TRACTION_CONTROL_KP" 8 "TRACTION_CONTROL_KI" 9 "TRACTION_CONTROL_KD" 10 "TRACTION_CONTROL_MIN_FRONT_RPM" 11 "POWER_LIMIT_ENABLED" 12 "POWER_CAP_KW" ;',
